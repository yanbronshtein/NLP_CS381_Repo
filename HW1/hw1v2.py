...
print("total number of unique words in the training set is including <s> and </s> is" + str(
    total_number_of_unique_words_in_training))
...
print(
    "The parameters needed for unigram model predication are each word so i, look, forward, to, hearing, your , reply , and . ")
